// ==UserScript==
// @name         ChatGPT Bookmark Manager — Fold Cube + Glass UI
// @namespace    http://tampermonkey.net/
// @version      6.0
// @description  可折叠为小方块，玻璃拟态面板，可拖动，自动记录问题。
...
(function () {
    ...
    function readableColor(bg = "#ffffff") {
        // 自动适配文字颜色：亮背景 → 黑字；暗背景 → 白字
        const c = bg.replace("#", "");
    ...
    function scanQuestions() {
        ...
        msgs.forEach((msg) => {
            ...
            Object.assign(blockTitle.style, {
                ...
                color: readableColor("#222222"),  // 自动适配色
            });
            ...
            blockTitle.onclick = () => {
                ...
                msg.style.outline = "3px solid hotpink";
